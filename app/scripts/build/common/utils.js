(function() {
      ...
      return _.extend(this, {
        ...
        navigator: {
          ...
          isIE9orLess: function() {
            return navigator.isIE9orLess;
          },
          isIE8orLess: function() {
            return navigator.isIE8orLess;
          }
        },
        reports: {
          extractPayload: function(dates) {
            return {
        ...
        csv: {
          extractPayload: (function(_this) {
            return function(dates, name) {
              var payload;
              payload = _this.reports.extractPayload(dates);
  ...
  return module.service('tryApply', [
